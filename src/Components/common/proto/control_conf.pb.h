...
class ControlConf :
 ...
 public:
  ...
  bool has_stanley_controller_conf() const;
  void clear_stanley_controller_conf();
  static const int kStanleyControllerConfFieldNumber = 39;
  const ::controller::StanleyControllerConf& stanley_controller_conf() const;
  ::controller::StanleyControllerConf* release_stanley_controller_conf();
...
// optional .controller.StanleyControllerConf stanley_controller_conf = 39;
inline bool ControlConf::has_stanley_controller_conf() const {
  return (_has_bits_[0] & 0x00000010u) != 0;
}
inline const ::controller::StanleyControllerConf& ControlConf::stanley_controller_conf() const {
  const ::controller::StanleyControllerConf* p = stanley_controller_conf_;
  // @@protoc_insertion_point(field_get:controller.ControlConf.stanley_controller_conf)
  return p != nullptr ? *p : *reinterpret_cast<const ::controller::StanleyControllerConf*>(
      &::controller::_StanleyControllerConf_default_instance_);
}
inline ::controller::StanleyControllerConf* ControlConf::release_stanley_controller_conf() {
  // @@protoc_insertion_point(field_release:controller.ControlConf.stanley_controller_conf)
  _has_bits_[0] &= ~0x00000010u;
  ::controller::StanleyControllerConf* temp = stanley_controller_conf_;
  stanley_controller_conf_ = nullptr;
  return temp;
}
inline ::controller::StanleyControllerConf* ControlConf::mutable_stanley_controller_conf() {
  _has_bits_[0] |= 0x00000010u;
  if (stanley_controller_conf_ == nullptr) {
    auto* p = CreateMaybeMessage<::controller::StanleyControllerConf>(GetArenaNoVirtual());
    stanley_controller_conf_ = p;
  }
  // @@protoc_insertion_point(field_mutable:controller.ControlConf.stanley_controller_conf)
  return stanley_controller_conf_;
}
inline void ControlConf::set_allocated_stanley_controller_conf(::controller::StanleyControllerConf* stanley_controller_conf) {
  ::google::protobuf::Arena* message_arena = GetArenaNoVirtual();
  if (message_arena == nullptr) {
    delete reinterpret_cast< ::google::protobuf::MessageLite*>(stanley_controller_conf_);
  }
  if (stanley_controller_conf) {
    ::google::protobuf::Arena* submessage_arena = nullptr;
    if (message_arena != submessage_arena) {
      stanley_controller_conf = ::google::protobuf::internal::GetOwnedMessage(
          message_arena, stanley_controller_conf, submessage_arena);
    }
    _has_bits_[0] |= 0x00000010u;
  } else {
    _has_bits_[0] &= ~0x00000010u;
