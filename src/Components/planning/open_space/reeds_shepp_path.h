#ifndef _REEDS_SHEPP_PATH_H_
#define _REEDS_SHEPP_PATH_H_
...
#define FLAGS_enable_parallel_hybrid_a false
...
class ReedShepp {
 public:
  ReedShepp(const vehicle::VehicleParam& vehicle_param,
